...
public class ColumnStatisticsImpl implements ColumnStatistics {
  ...
  public static final class BooleanStatisticsImpl extends ColumnStatisticsImpl
  ...
  public static final class IntegerStatisticsImpl extends ColumnStatisticsImpl
  ...
  public static final class DoubleStatisticsImpl extends ColumnStatisticsImpl
  ...
  public static final class StringStatisticsImpl extends ColumnStatisticsImpl
  ...
  public static final class BinaryStatisticsImpl extends ColumnStatisticsImpl implements
  ...
  public static final class DecimalStatisticsImpl extends ColumnStatisticsImpl
  ...
  public static final class DateStatisticsImpl extends ColumnStatisticsImpl
    ...
    @Override
    public void updateDate(Integer value) {
      if (minimum == null) {
        minimum = value;
        maximum = value;
    ...
    /** Convert a number of days into a number of milliseconds in the local
     * timezone to get the correct Date.
     * @param d the number of days since 1 Jan 1970
     * @return the number of milliseconds in the local timezone
     */
    ...
    public Date getMinimum() {
      ...
      return new Date(daysToMillis(minimum));
    }
    ...
    public Date getMaximum() {
      ...
      return new Date(daysToMillis(maximum));
    }
  ...
  public static final class TimestampStatisticsImpl extends ColumnStatisticsImpl
