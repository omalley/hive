...
import org.apache.hadoop.hive.storage.DiskRangeList.DiskRangeListMutateHelper;
...
public class RecordReaderUtils {
  private static final Log LOG = LogFactory.getLog(RecordReaderUtils.class);
   ...
   */
  public static boolean overlap(long leftA, long rightA, long leftB, long rightB) {
    if (leftA <= leftB) {
      return rightA >= leftB;
    }
    return rightB >= leftA;
  ...
  public static final int WORST_UNCOMPRESSED_SLOP = 2 + 8 * 512;
   ...
   * @throws IOException
   */
  public static DiskRangeList readDiskRanges(FSDataInputStream file,
  ...
  public static List<DiskRange> getStreamBuffers(DiskRangeList range,
  ...
  public static HadoopShims.ZeroCopyReaderShim
                 createZeroCopyShim(FSDataInputStream file,
